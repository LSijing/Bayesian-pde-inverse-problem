...
# problem definition
num_kl = 30
N, Nob, num_kl, observe_mat, true_theta, u, y, hmc_inv_pde = example2.get_problem_settings(num_kl=num_kl)
leap_frog_step_num, step_size, total_iter_num, burn_in_num, start_theta, num_sol_basis, num_grad_basis = example2.get_algorithm_settings(num_kl=num_kl)
